        ...
        <div class="col-12">
            <div class="login-card">
                ...
                <div class="login-main">
                    <form class="theme-form" method="post" action="{{url('do_login')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type="password" name="password" id="password" placeholder="*********">
                        ...
                        <p class="mt-4 mb-0">Don't have account?<a class="ms-2" href="{{ url('/register') }}">Create Account</a></p>
                    </form>
                </div>
                </div>
            </div>
