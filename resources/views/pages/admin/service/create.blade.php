                    ...
                    <div class="card-body">
                        <form enctype='multipart/form-data' action="{{route('admin.service.store')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('service_price') is-invalid @enderror" id="service_price" type="text"placeholder="Enter service Price" name="service_price">
                                 @error('service_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label pt-0" for="service_description">Service Description</label>
                                    <textarea id="text-box" name="service_description" cols="10" rows="2"></textarea>
                                {{-- <textarea class="CodeMirror smde @error('service_description') is-invalid @enderror" id="service_description" name="service_description"></textarea> --}}
