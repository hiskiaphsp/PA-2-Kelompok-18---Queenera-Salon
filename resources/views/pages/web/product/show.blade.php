<x-web-layout title="Product Detaill">
                                    ...
                                    <div class="tpproduct-details__nab">
                                       <div class="tab-content" id="nav-tabContents">
                                          <div class="tab-pane fade show active w-img" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                                             <img src="{{asset('web-assets/img/product/product-details-1.png')}}" alt="">
                                             <div class="tpproduct__info bage">
                                                <span class="tpproduct__info-hot bage__hot">HOT</span>
                                             </div>
                                          </div>
                                          <div class="tab-pane fade w-img" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
                                             <img src="{{asset('web-assets/img/product/product-details-2.png')}}" alt="">
                                             <div class="tpproduct__info bage">
                                          ...
                                          <div class="tab-pane fade w-img" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                                             <img src="{{asset('web-assets/img/product/product-details-3.png')}}" alt="">
                                             <div class="tpproduct__info bage">
                                                <span class="tpproduct__info-hot bage__hot">HOT</span>
                                             </div>
                                          </div>
                                       ...
                                       <nav>
                                          <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                             <img src="{{asset('web-assets/img/product/product-detaisl-item1.png')}}" alt="">
                                            </button>
                                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                                             <img src="{{asset('web-assets/img/product/product-detaisl-item2.png')}}" alt="">
                                            </button>
                                            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                                             <img src="{{asset('web-assets/img/product/product-detaisl-item3.png')}}" alt="">
                                            </button>
                                          </div>
                                        </nav>
                                    </div>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="product__details">
                                       ...
                                       <div class="product__details-payment text-center">
                                          <img src="{{asset('web-assets/img/shape/payment-2.png')}}" alt="">
                              ...
                              <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab" tabindex="0">
                                 ...
                                 <div class="tpdescription__product-wrapper mt-30 mb-30 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="tpdescription__product-thumb">
                                       <img src="{{asset('web-assets/img/product/product-single-1.png')}}" alt="">
                                    </div>
                                 </div>
                                 <div class="tpdescription__video">
                                    ...
                                    <div class="tpdescription__video-wrapper p-relative mt-30 mb-35 w-img">
                                       <img src="{{asset('web-assets/img/product/product-video1.jpg')}}" alt="">
                              ...
                              <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-info-tab" tabindex="0">
                                 ...
                                 <div class="tpdescription__product-wrapper mt-30 mb-30 d-flex justify-content-between align-items-center">
                                    <div class="tpdescription__product-info">
                                       ...
                                       <p>Lemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut </p>
                                    </div>
                                    <div class="tpdescription__product-thumb">
                                       <img src="{{asset('web-assets/img/product/product-single-1.png')}}" alt="">
                                    </div>
                  ...
                  <div class="col-lg-2 col-md-12">
                     <div class="tpsidebar pb-30">
                        ...
                        <div class="tpsidebar__banner mb-30">
                           <img src="{{asset('web-assets/img/shape/sidebar-product-1.png')}}" alt="">
                        </div>
                        <div class="tpsidebar__product">
                           ...
                           <div class="tpsidebar__product-item">
                              <div class="tpsidebar__product-thumb p-relative">
                                 <img src="{{asset('web-assets/img/product/sidebar-pro-1.jpg')}}" alt="">
                           ...
                           <div class="tpsidebar__product-item">
                              <div class="tpsidebar__product-thumb p-relative">
                                 <img src="{{asset('web-assets/img/product/sidebar-pro-2.jpg')}}" alt="">
                                 <div class="tpsidebar__info bage">
                                    <span class="tpproduct__info-hot bage__hot">HOT</span>
                                 </div>
                              </div>
                           ...
                           <div class="tpsidebar__product-item">
                              <div class="tpsidebar__product-thumb p-relative">
                                 <img src="{{asset('web-assets/img/product/sidebar-pro-3.jpg')}}" alt="">
                                 <div class="tpsidebar__info bage">
                                    <span class="tpproduct__info-hot bage__hot">HOT</span>
                                 </div>
                              </div>
         ...
         <!-- feature-area-start -->
         <section class="feature-area mainfeature__bg pt-50 pb-40" data-background="{{asset('web-assets/img/shape/footer-shape-1.svg')}}">
            <div class="container">
